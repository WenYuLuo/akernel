...
openssl req -x509 -newkey rsa:2048 -nodes \
  ...
  -addext "subjectAltName=DNS:adx.internal,DNS:localhost,DNS:akernel-adx-control,DNS:akernel-adx-control.${namespace}.svc.cluster.local,IP:127.0.0.1" >/dev/null 2>&1
