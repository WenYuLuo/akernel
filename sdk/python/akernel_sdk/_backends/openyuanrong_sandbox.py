...
class _Session:
    def __init__(self, sandbox: Any, *, detached: bool) -> None:
...
class OpenYuanRongSandboxBackend:
    """HTTP/RRT backend implemented by ``openyuanrong-sandbox``."""
    ...
    def create(self, spec: SandboxSpec) -> BackendSession:
        ...
        return _Session(sandbox, detached=spec.detached)
...
def create_backend(config: BackendConfig) -> Backend:
    """Construct the HTTP/RRT backend for the lazy registry."""
