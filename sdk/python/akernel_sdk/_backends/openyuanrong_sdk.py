...
def _rollback_instance(instance: Any, operation: str) -> None:
    try:
        _openyuanrong.terminate_instance(instance)
    except Exception:
        logger.warning(
...
class OpenYuanRongSdkBackend:
    ...
    def create(self, spec: SandboxSpec) -> BackendSession:
        ...
        try:
            sandbox_id = _openyuanrong.real_instance_id(instance)
        except Exception as error:
        ...
        try:
            if spec.reverse_tunnel is not None:
                tunnel_client = _openyuanrong.start_reverse_tunnel(
                    instance,
                    spec.reverse_tunnel,
                    name=spec.name,
                )
